...
public class BluetoothConnectionService {
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                ...
                try {
                    bytes = mmInStream.read(buffer);
                     //incomingMessage =java.nio.ByteBuffer.wrap(buffer).getInt();
        ...
        public void write(byte[] bytes) {
           ...
           // int text =java.nio.ByteBuffer.wrap(bytes).getInt();
    ...
    public String returnInbound()
    {
        return mConnectedThread.returnIncomingMsg();
    }
